...
export default function Header() {
    return (
        <section
            className="mx-auto gap-4 grid sm:min-h-[68px] place-items-center grid-cols-[auto,110px,40px] grid-cols-[1fr,auto,auto] md:grid-cols-[auto,1fr,110px,40px] max-w-xl 3xl:max-w-7xl overflow-hidden px-4 py-2 font-bold text-white font-[LetsGoDigital]">
            <h1 className="whitespace-nowrap justify-self-start">
